...
/**
 * swap_ints - wap tswo integers in an array
 ...
 * @size: size of array
 * @start: its starting index of the sequence in array to sort
...
/**
 * bitonic_seq - Converts array of integers into a bitonic sequence
 * @array: array of integers
 * @size: size of array.
...
/**
 * bitonic_sort - array of integers sorted in ascending
